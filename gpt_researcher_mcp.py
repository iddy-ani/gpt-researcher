...
async def conduct_research_task(arguments: dict) -> list[dict]:
    ...
    try:
        ...
        # Conduct research
        print(f"🔍 Starting research on: {query}", file=sys.stderr)
...
async def quick_research(arguments: dict) -> list[dict]:
    ...
    try:
        ...
        print(f"⚡ Starting quick research on: {query}", file=sys.stderr)
...
async def generate_subtopics(arguments: dict) -> list[dict]:
    ...
    try:
        ...
        print(f"🧩 Generating subtopics for: {query}", file=sys.stderr)
...
Status: """ + ("✅ Active" if os.getenv('EGPT_API_KEY') else "⚠️ API Key Required")
...
async def main():
    ...
    try:
        ...
        print("🚀 Starting GPT Researcher MCP Server...", file=sys.stderr)
